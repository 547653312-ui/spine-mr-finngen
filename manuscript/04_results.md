...
After Benjamini–Hochberg FDR and Bonferroni correction across the 45 primary IVW tests, no association survived as a credible finding; the single FDR-significant result (leukocyte→SPONDINF, FDR=0.009) is discounted on the grounds above.
...
*Table 5. Multivariable MR (MVMR) adjusting for body-mass index (BMI_IRN, n=321,672), type-2 diabetes (T2D, n=71,728) and smoking (SMOKING, n=4,271). Univariable column = fixed-effects IVW; adjusted column = fixed-effects IVW with overdispersion correction (φ≥1).*
