...
**Sensitivity analyses.** Heterogeneity was assessed by Cochran Q (significant at P<0.05) and I² across instruments²⁶. Pleiotropy was assessed by the MR-Egger intercept and its P-value²⁵. Leave-one-out analysis re-estimated the effect excluding each SNP sequentially, with funnel diagnostics examined as a visual check²⁷. Directionality was assessed by the Steiger test comparing variance in exposure vs outcome explained by the instruments²³; a significant exposure→outcome directionality supports the assumed causal direction. Multiple-testing control applied Benjamini–Hochberg FDR and Bonferroni correction across the 45 exposure–outcome pairs.
